...
y
Attention: Directories /home/wfg/.cache/epkg and /home/wfg/.epkg/envs/self will be created.
...
```shell
wfg@crystal ~% tree ~/.epkg/envs/self/profile-current/
/home/wfg/.epkg/envs/self/profile-current/
├── bin -> usr/bin
├── etc
│   ├── epkg
│   │   └── channel.yaml
