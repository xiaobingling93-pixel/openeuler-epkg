...
The below {filehash} in "filename" field can be any distinct string, e.g. date + the first 8 chars of "sha256sum" field. Tools should not make assumption on how it is generated and try to extract/use the values in the file name.

```json
{
  "store-paths": [
    {
      "filename": "store-paths-20250109-b6fe951d.txt.zst",
      "sha256sum": "b6fe951d3e982c1804873bd84aaad1453b0cc3e54803e09e4d497376b8297e61",
      "datetime": "2025-01-09 11:33 +800"
    },
    {
